...
export default function LandingPage() {
  return (
    ...
    <>
      ...
      <section className="z-10 mb-20 flex h-[85vh] flex-col justify-evenly px-8 pb-8 sm:mb-20 sm:px-16 md:mb-20 md:h-[90vh] lg:mb-20 lg:h-[85vh] lg:justify-center xl:h-[85vh] xl:justify-center xl:px-36 xl:py-16">
