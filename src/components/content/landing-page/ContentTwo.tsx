...
const ContentTwo = (): JSX.Element => {
  return (
    ...
    <section className="relative flex h-full flex-col items-center space-y-8 px-0 py-8 text-start text-lg xl:h-[95vh] xl:px-36 xl:pb-0 xl:pt-16 xl:text-center">
