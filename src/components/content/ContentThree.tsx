...
const ContentThree = (): JSX.Element => {
  return (
    <div className="relative flex h-full flex-col items-center space-y-8 bg-customWhite px-8 py-8 text-lg  sm:px-36 xl:space-y-16 xl:px-36 xl:py-16">
      ...
      <section className="flex flex-wrap justify-around space-y-8 xl:space-y-0">
        <div className="contentThreeContainer popUpAnimation">
          <h3 className="text-center text-2xl text-secondary xl:text-3xl">
            Body Mass Index
          </h3>
        ...
        <div className="contentThreeContainer popUpAnimation">
          <h3 className="text-center text-2xl text-primary xl:text-3xl">
            Vital Signs Check
          </h3>
